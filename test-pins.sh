...
echo -e "\n"
echo "update a pin"
curl -i -H "Content-Type: application/json" -X PUT -d '{"pin_Id": "1", "pinName": "My favourite Food", "pinImage": "food1.jpg", "pinDesc": "My Favorite food"}' http://127.0.0.1:5000/users/2/boards/Food/pins/1/ 
echo -e "\n"
...
echo -e "\n"
echo "delete a pin"
curl -i -H "Content-Type: application/json" -X DELETE http://127.0.0.1:5000/users/2/boards/Food/pins/1/
echo -e "\n"
