...
curl -i -H "Content-Type: application/json" -X GET http://127.0.0.1:5000/users/1/public/
echo -e "\n"
...
echo -e "\n"
echo "update a board"
curl -i -H "Content-Type: application/json" -X PUT -d '{"boardName":"Food","boardDesc":"Amazing food","Indian category": "My Favorite Food","isPrivate": "false"}' http://127.0.0.1:5000/users/1/boards/Food/
echo -e "\n"

#delete a board
echo -e "\n"
echo "delete a board"
curl -i -H "Content-Type: application/json" -X DELETE http://127.0.0.1:5000/users/1/boards/Food/
echo -e "\n"
...
echo -e "\n"
echo "get all boards "
curl -i -H "Content-Type: application/json" -X GET http://127.0.0.1:5000/users/1/boards/
echo -e "\n"
