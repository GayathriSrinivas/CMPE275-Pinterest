...
curl -i -H "Content-Type: application/json" -X POST -d '{"pinComment": "Very cool1"}' http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/
echo -e "\n"
curl -i -H "Content-Type: application/json" -X POST -d '{"pinComment": "Very cool2"}' http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/
echo -e "\n"
curl -i -H "Content-Type: application/json" -X POST -d '{"pinComment": "Very cool3"}' http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/
echo -e "\n"
curl -i -H "Content-Type: application/json" -X POST -d '{"pinComment": "Very cool4"}' http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/
echo -e "\n"
...
curl -i -H "Content-Type: application/json" -X PUT -d '{"comment_Id": "1", "pinComment": "Very very cool"}' http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/1/ 
echo -e "\n"
...
curl -i -H "Content-Type: application/json" -X DELETE http://127.0.0.1:5000/users/1/boards/Food/pins/1/comments/1/
echo -e "\n"
